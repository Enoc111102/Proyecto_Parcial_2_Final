	...
	do
	{
		...
		case '1':
			...
			cout << "Has elegido Binario-Decimal. \n";
			{
				...
				cout << endl << "El Decimal es: " << MAGENTA << decimal << endl;
				getwchar();
			}
			pausa();
			break;
		...
		case '2':
			...
			cout << "Has elejido Decimal-Binario. \n";
			{
				...
				cout << "binario: " << MAGENTA << binario << endl;
				getwchar();
			}
			pausa();
			break;
		...
		case '3':
			...
			cout << "Has elejido Binario-Octal. \n";
			{
				...
				cin >> cgrup;
				{
					...
					cout << " El codigo Octal es: " << MAGENTA << resultado << endl;
					getwchar();
				}
			}
			pausa();
					...
					{
						{
							...
							cout << " El codigo Hexadecimal es: " << MAGENTA << resultado << endl;
						}
					}
					getwchar();
				}
